...
const InfoList = ({ info }) => {
  ...
  return (
    <div className="m-6 relative -top-36 md:-inset-y-32 lg:-inset-y-24 md:my-6">
      <div
        className="bg-white text-center mt-4 rounded-xl p-4 max-w-full md:grid md:grid-cols-auto-fit-medium lg:grid-cols-auto-fit  md:justify-evenly md:w-5/6 md:mx-auto md:text-xs md:text-left md:px-4 md:p-0 md:max-w-7xl
      "
      >
